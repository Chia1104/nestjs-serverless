...
console.info(
  "Copying node_modules into .vercel/output/functions/index.func/node_modules"
);
fs.cpSync("node_modules", ".vercel/output/functions/index.func/node_modules", {
  recursive: true,
...
console.info(
  "Copying .vc-config.json into .vercel/output/functions/index.func"
);
fs.cpSync(
  "infra/vercel/.vc-config.json",
